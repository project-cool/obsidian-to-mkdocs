...
echo -e "\n"
echo "xargs----"
time find $docsPath -name '*.png' | xargs -I % mogrify -path % -resize $resolution -format jpg -quality $compressionQuality % 

time find $docsPath -name '*.jpg' | xargs -I % mogrify -path % -resize $resolution -format jpg -quality $compressionQuality % 

time find $docsPath -name '*.jpeg' | xargs -I % mogrify -path % -resize $resolution -format jpg -quality $compressionQuality % 

time find $docsPath -name '*.tiff' | xargs -I % mogrify -path % -resize $resolution -format jpg -quality $compressionQuality % 

time find $docsPath -name '*.webp' | xargs -I % mogrify -path % -resize $resolution -format jpg -quality $compressionQuality % 
